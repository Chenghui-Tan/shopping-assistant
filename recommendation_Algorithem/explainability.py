...
_PREFIX_RULE_TEXT: dict[str, str] = {
    "structure_":            "Matches the organizer style you picked: ",
    ...
    "organizer_material_":   "Matches the organizer material you picked: ",
}

# Map of additional smart_display + organizer rules.
_RULE_TEXT.update({
