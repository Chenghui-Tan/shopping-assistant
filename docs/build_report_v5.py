...
toc_rows = [
    ...
    ("    4.7  Preference Continuity Across Turns", "14"),
    ("    4.8  Personalised Lifecycle Layer", "15"),
    ("5.  Results", "16"),
    ("    5.1  Scenario-Based Evaluation", "16"),
    ("    5.2  Comparison Against Baselines", "17"),
    ("    5.3  Behavioural Observations", "18"),
    ("6.  Conclusions and Impact", "19"),
    ("7.  Contributions", "20"),
    ("    7.1  Team Members", "20"),
    ("    7.2  AI Tool Contributions", "20"),
    ("8.  References", "21"),
    ("9.  Appendix — Code Listings", "22"),
]
...
para(
    ...
    "(iii) Descriptions were not scraped at all (all 100 came back null) and are synthesised "
    ...
    "Promotions and live availability are not modelled at all and would require a daily "
...
para(
    ...
    "sentences via a 26-entry rule->text dictionary defined alongside the scoring rules. "
...
heading(2, "Personalised Lifecycle Layer", "4.8")
para(
...
para(
    "Five behaviours emerged consistently during informal scenario walkthroughs and from "
...
bullet("Lifecycle reinforces the purchase. Scene 5 changes the perceived value of the assistant "
       "from a transactional tool to a daily routine. The Iter B personalisation pass added ten "
...
# ─── Save ──────────────────────────────────────────────────────────────────────
import os
out_path = os.path.join(os.path.dirname(__file__), "capstone_report_v3.docx")
doc.save(out_path)
