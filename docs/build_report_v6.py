...
toc_rows = [
    ...
    ("    1.4  Scope and What This Report Is Not", "5"),
    ("2.  Related Work", "6"),
    ("    2.1  Search-Oriented E-Commerce Platforms", "6"),
    ("    2.2  Conversational Shopping Assistants", "6"),
    ("    2.3  AI-Powered Answer Engines", "7"),
    ("    2.4  Recommender Systems and Explainability", "7"),
    ...
    ("    4.2  ETL Pipeline", "11"),
    ("    4.3  Dimensional Model", "12"),
    ("    4.4  Ranking and Decision Logic", "13"),
    ("    4.5  Explainability Layer", "14"),
    ("    4.6  Visualization and Five-Scene UI", "15"),
    ("    4.7  Preference Continuity Across Turns", "15"),
    ("    4.8  Personalized Lifecycle Layer", "16"),
    ("    4.9  Curated Three-Pick Layer + Factual Trade-off Labels", "17"),
    ("    4.10 Preference Match Checklist", "17"),
    ("    4.11 Side-by-Side Comparison View", "18"),
    ("    4.12 Deterministic Fallbacks for Every LLM Call", "18"),
    ("5.  Results", "19"),
    ...
    ("6.  Conclusions and Impact", "25"),
    ("7.  Contributions", "26"),
    ("    7.1  Team Members", "26"),
    ("    7.2  AI Tool Contributions", "26"),
    ("8.  References", "27"),
    ("9.  Appendix — Code Listings", "28"),
    ("    9.1  ETL Pipeline Orchestrator", "28"),
    ("    9.2  Delivery Normalization", "28"),
    ("    9.3  Constraint-Aware Ranking", "29"),
    ("    9.4  Scoring Rule (water_bottle gym)", "29"),
    ("    9.5  FastAPI Routes", "30"),
    ("    9.6  Trust Boundary in the Pipeline", "30"),
    ("    9.7  Curated 3-Pick Differentiation", "31"),
    ("    9.8  Preference Match Checklist", "31"),
    ("    9.9  Deterministic Refine Parser", "32"),
]
...
para(
    ...
    "ChatGPT Shopping, Google Shopping, and Perplexity. Two qualitative claims are realised "
...
heading(2, "Scope and What This Report Is Not", "1.4")
para(
...
make_table([
    ...
    ("Kitchen Organizer", "Target",              "35",    "4.8★",        "$2–$45"),
    ("Total",             "—",                   "100",   "4.7★",        "$2–$424"),
...
heading(2, "Preference Continuity Across Turns", "4.7")
para(
...
heading(2, "Personalized Lifecycle Layer", "4.8")
para(
...
heading(2, "Curated Three-Pick Layer + Factual Trade-off Labels", "4.9")
para(
...
heading(2, "Preference Match Checklist", "4.10")
para(
...
heading(2, "Side-by-Side Comparison View", "4.11")
para(
...
heading(2, "Deterministic Fallbacks for Every LLM Call", "4.12")
para(
...
para(
    ...
    "five-scene flow and compare the system's behavior against three reference assistants "
...
para(
    "Table 8 summarizes the four sources and their distinct evaluation lenses. Table 9 "
...
caption("Table 8: Four validation sources and their distinct evaluation lenses.")
...
make_table([
    ...
    ("'Lowest-cost' message could fire when untrue",   "Replaced by factual tradeoff_labels with spread requirement (§4.9)"),
], col_widths=[3.4, 3.6])
caption("Table 9: Representative Codex GPT-5.5 findings and corresponding fixes.")
...
bullet("Codex GPT-5.5 (OpenAI) was run as an independent technical validator against the same "
       ...
       "Representative findings and their corresponding fixes are listed in Table 9. Each "
...
refs = [
    ...
    "[16] Anthropic, “Claude Opus 4.7 model card,” Anthropic, 2026. [Online]. Available: https://www.anthropic.com",
...
code_block('''def curated_picks(ranked, category):
    ...
    # Budget Pick: cheapest in top-quartile that still scores >= 75% of best.
    score_floor = (best.get("_score") or 0.0) * 0.75
    budget_pool = sorted(
        [p for p in ranked[1:] if (p.get("_score") or 0.0) >= score_floor],
...
caption("Listing 7: Differentiated three-pick selection. The score_floor and "
        ...
        "minor-difference product from claiming the Stretch slot.")
...
# ─── Save ──────────────────────────────────────────────────────────────────────
import os
out_path = os.path.join(os.path.dirname(__file__), "capstone_report_v4.docx")
doc.save(out_path)
