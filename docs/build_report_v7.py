...
caption("Table 7: Capability comparison against three representative baselines. Cells reflect "
...
para(
    ...
    "suite before this revision was produced. Table 10 summarizes the findings and the "
...
caption("Table 10: Self-audit findings and the corresponding code fix. Only the first "
...
# ─── Save ──────────────────────────────────────────────────────────────────────
import os
out_path = os.path.join(os.path.dirname(__file__), "capstone_report_v5.docx")
doc.save(out_path)
